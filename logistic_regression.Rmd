...
Imagine there are 100 people standing in a room. 20 of them are civil servants. If we picked a person at random, the probability they
...
```{python}
print('Intercept from minimize =', inter_logistic_reg_MLL)
print('Slope from minimize =', slope_logistic_reg_MLL)
```
...
plt.scatter(hemoglobin, sm_predictions,
            label = 'Statsmodels predictions', color = 'cyan')
plt.legend();
```
