...
that multiplying by 0 gives 0.  

We can form the `predicted_prob_of_actual_score` column by first
...
* Consider the expression `np.sum(np.log(predicted_prob_of_actual_score)` in the
