...
def plotly_3D_with_plane(dataset, x1_string, x2_string, y_string, hover_string_list,
    ...
    scatter_3d.add_trace(go.Surface(x=x1, y=x2, z=y, opacity=0.1))
...
However, statistical adjustment *can* also affect the direction of the slope, as we will now see.
<!-- #endregion -->
...
```{python}
# generate the plot
plotly_3D_with_plane(epl, 'forward', 'defense', 'goal_difference', ['team'],
                     epl_goaldiff_forward_defense_slope_forw,
                    epl_goaldiff_forward_defense_slope_def,
                    epl_goaldiff_forward_defense_intercept)
```
