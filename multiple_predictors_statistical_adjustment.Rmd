...
def plotly_3D_with_plane(dataset, x1_string, x2_string, y_string, hover_string_list,
    ...
    scatter_3d.add_trace(go.Surface(x=x1, y=x2, z=y, opacity=0.4))
...
def make_scatter(x, y, b, c, with_errors = True, show = False,
    ...
    if show == True:
        plt.show()
make_scatter(education_2, prestige_2, duncan_prestige_education_2_slope, duncan_prestige_education_2_intercept)
```
...
```{python}
# do not worry about this code, it is just to generate the 3D plots
def single_multi_comparison_subplots(x1 = type_dummy, x2 = education_2, y = prestige_2,
                                     x1_label = 'Type\n{0 = prof, 1 = bc}',
                                       x2_label = 'Education',
                                       y_label = 'Prestige',
                                       plane_alpha = 0.5,
