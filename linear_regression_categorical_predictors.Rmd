...
These univariate distributions are conveying the same information - they tell us the number of observational units at each value the variable can take - they just look so different because the variables they are repsenting are of different types (e.g. `income` is a numeric variable; `type` is a binary categorical variable). **This is an important point to remember for the rest of the page...**
